export const translations = {
    en: {
      ...
      "hero.summary": "Electronics engineer and full-stack developer from Bogotá. Six years building end to end: PCBs, embedded firmware, .NET backends, Edge AI in the field. I founded DevKit Electronics (one of two official founders) and co-founded Poimen Labs. NAVIRA-SATViRe, our IoT early-warning system, won a national UNGRD hackathon.",
      "hero.cv": "Download CV",
      ...
      "sec1.title": "Profile",
      "sec1.note": "Who I am",
      "about.lead": "Electronics engineer and full-stack developer. Six years on projects that mix hardware, software and data: from international trade platforms to Edge AI, FPGA design and applied robotics.",
      "about.t1": "DevKit Electronics founder",
      ...
      "xpdk.lead": "STEM education company I founded. We build hardware, software and curricula that work in real classrooms and labs.",
      "xpdk.b1": "Founded DevKit Electronics. I am one of two official founders and have led strategy, operations and product direction for more than two years in engineering and science education for children, youth, university students and professionals.",
      ...
      "xpdk.b3": "Built a portfolio of courses, robotics kits and lab systems adopted by schools and universities, with repeatable programs and equipment institutions can deploy on their own.",
      ...
      "xpdk.b5": "Turn complex engineering (STM32, IoT, 3D fabrication, automation) into learning experiences that scale from introductory workshops to advanced university labs.",
      "xppo.date": "2025 - Present",
      "xppo.meta": "Co-founder",
      "xppo.role": "Co-founder & General Manager",
      "xppo.lead": "AgriTech venture I co-founded to bring electronics, automation, sensing and data to Colombian agriculture, from prototype to field deployment.",
    ...
    es: {
      ...
      "hero.summary": "Ingeniero electrónico y desarrollador full-stack en Bogotá. Más de seis años construyendo de punta a punta: PCB, firmware embebido, backends .NET, Edge AI en campo. Fundé DevKit Electronics (soy uno de los dos fundadores oficiales) y soy cofundador de Poimen Labs. NAVIRA-SATViRe, nuestro sistema IoT de alerta temprana, ganó una hackatón nacional de la UNGRD.",
      ...
      "sec1.title": "Perfil",
      "sec1.note": "Quién soy",
      "about.lead": "Ingeniero electrónico y desarrollador full-stack. Llevo más de seis años en proyectos que mezclan hardware, software y datos: desde plataformas de comercio exterior hasta Edge AI, FPGA y robótica aplicada.",
      "about.t1": "Fundador de DevKit Electronics",
      ...
      "xpdk.lead": "Empresa de educación STEM que fundé. Hacemos hardware, software y currículos que funcionan en aulas y laboratorios reales.",
      "xpdk.b1": "Fundé DevKit Electronics. Soy uno de los dos fundadores oficiales y llevo más de dos años dirigiendo estrategia, operación y producto en educación de ingeniería y ciencias para niños, jóvenes, universitarios y profesionales.",
      ...
      "xpdk.b3": "Construí un portafolio de cursos, kits de robótica y sistemas de laboratorio adoptados por colegios y universidades, con programas replicables y equipos que las instituciones pueden desplegar por su cuenta.",
      ...
      "xpdk.b5": "Traduzco ingeniería compleja (STM32, IoT, fabricación 3D, automatización) en experiencias de aprendizaje que van desde talleres introductorios hasta laboratorios universitarios avanzados.",
      ...
      "xppo.b3": "Desarrollo sistemas de monitoreo y automatización de bajo costo para cultivos y ganadería: electrónica robusta, firmware eficiente en energía y telemetría pensada para condiciones reales de finca.",
      ...
      "xppo.b5": "Gestiono el ciclo completo del producto: levantamiento de requisitos con productores, diseño de PCB y carcasa, firmware, servicios backend, pilotos en campo y mejora iterativa con retroalimentación real.",
